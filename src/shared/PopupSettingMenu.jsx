...
const PopupSettingMenu = ({bgColor}) => {
    ...
    return (
        <div className={`fixed bottom-0 right-0 z-50 flex items-center justify-center mb-5 mr-5 text-white rounded-full shadow-lg cursor-pointer w-14 h-14 bg-[${bgColor}]`}
        onClick={toggleActivitySidebar}>
            ...
            {activitySidebarOpen && <ActivitySidebar />}
        </div>
    );
};

export default PopupSettingMenu;