...
const PasswordChangedSuccessfullyHint = () => {
    ...
    return (
        <div
            ...
            <div className="ml-1 mr-6 font-medium">
                If you encounter any issues, please contact our Call Center for assistance.
            </div>
            <button
                type="button"
...
export default PasswordChangedSuccessfullyHint;