...
const ConfirmPasswordSent = () => {
    return (
        <section id={'confirm-password-send'}>
            <div
                ...
                <div
                    ...
                    <div className={`relative z-10 flex flex-col justify-center w-full h-full lg:py-20`}>
                        ...
                        <div className="mt-12">
                            <div className={`mb-4`}>
                                <img src={Successfully}  alt={'password changes successfully image'} className={`mx-auto h-[52px]`} />
                            </div>
                            <h3 className={`text-lg text-[#0E89BE] font-semibold text-center`}>
                                Thank you for registering!
                            </h3>

                            <h3 className={`text-sm text-[#3F4E63] font-semibold text-center mt-2`}>
                                Please check your email to activate your account and log in.
                            </h3>

                            <PasswordChangedSuccessfullyHint/>
            ...
            <AuthAirplaneConfirmRegistering/>
...
export const AuthAirplaneConfirmRegistering = () => {
    return (
            ...
            <div className="h-full col-span-7 2xl:col-span-8 3xl:col-span-9 lg:relative before:content-[''] before:absolute before:lg:-ml-10 before:left-0 before:inset-y-0 before:bg-gradient-to-b before:from-[#03045E] before:to-[#0C4A6E] before:w-screen before:lg:w-[800%]">
                <div className="mix-blend-screen sticky top-0 z-10 flex-col justify-center hidden h-screen lg:flex">
                    <div className="relative">
                        <img src={ConfirmRegistering} alt="airplane image" className="h-[100%] w-[100%]" />
