import {SigninImage, TotalLogo} from "../../assets/index.js";
...
const SignIn = () => {
    ...
    const NavigateDashboardAnalytics = () => {
        navigate('/');
    }
            ...
            <div
                ...
                <div
                    ...
                    <div className={`relative z-10 flex flex-col justify-center w-full h-full lg:py-20`}>
                        ...
                        <div className="mt-8">
                            <h3 className={`text-lg text-[#66768C] leading-7 font-GothamBold uppercase text-center`}>Sign In</h3>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex mt-4 text-xs text-slate-500">
                                    <div className="flex items-center mr-auto">
                                        ...
                                        <label className="text-xs text-[#A3AEBE] cursor-pointer select-none"
                                               htmlFor="remember-me">Remember me</label>
                                    </div>
                                    <a className="text-xs text-[#97A5B7] cursor-pointer" onClick={NavigateForgotPassword}>Forgot Password?</a>
                                </div>

                                <div className="mt-5 text-center xl:mt-8 xl:text-left">
                                    <SignButton className={`mb-2`} buttonType={'contained'} onClick={NavigateDashboardAnalytics}>Sign In</SignButton>

                                    <SignButton buttonType={'outlined'} onClick={NavigateSignUp}>Sign Up</SignButton>
                                </div>
...
export const AuthAirplaneSignin = () => {
    return (
            ...
            <div className="h-full col-span-7 2xl:col-span-8 3xl:col-span-9 lg:relative before:content-[''] before:absolute before:lg:-ml-10 before:left-0 before:inset-y-0 before:bg-gradient-to-b before:from-[#03045E] before:to-[#0C4A6E] before:w-screen before:lg:w-[800%]">
                <div className="mix-blend-screen sticky top-0 z-10 flex-col justify-center hidden h-screen lg:flex">
                    <div className="relative">
                        <img src={SigninImage} alt="airplane image" className="h-[100%] w-[100%] object-contain" />
