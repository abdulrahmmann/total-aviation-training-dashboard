...
import {InsightsCards} from "../utils/Constants.js";

const InsightsCardsSlider = ({onCardClick }) => {
                ...
                {InsightsCards.map((card) => (
                    <div key={card.Id}>
                        <SliderCard
                            ...
                            onExploreClick={() => onCardClick(card.Title)}
                        />
                    </div>
                ))}
            </TinySlider>
...
export default InsightsCardsSlider;
